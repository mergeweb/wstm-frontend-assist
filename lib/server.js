//Simple HTTP server in NodeJS (see https://blog.bitsrc.io/a-beginners-guide-to-server-side-web-development-with-node-js-17385da09f93)
...
const port = 8080 //port to serve files to
